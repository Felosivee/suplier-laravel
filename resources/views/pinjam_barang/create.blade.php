   ...
   <form action="{{ route('pinjam_barang.store') }}" method="POST">
     ...
     <div class="border-b border-gray-900/10 pb-12">
       ...
       <div class="mt-5 col-span-full gap-y-8">
         ...
         <div class="mt-2">
           <input id="tgl_pinjam" name="tgl_pinjam" type="date" autocomplete="tgl_pinjam" value="{{ old('tgl_pinjam') }}" required class="block w-full rounded-md border-0 py-1.5 pl-3 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm/6">
         </div>
       </div>
    ...
    <div class="mt-2">
        <input id="tgl_kembali" name="tgl_kembali" type="date" value="{{ old('tgl_kembali') }}" class="block w-full rounded-md border-0 py-1.5 pl-3 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm">
    </div>
</div>
<div class="mt-5 col-span-full gap-y-8">
    <label for="kondisi" class="block text-sm font-medium text-gray-900">Kondisi Barang</label>
    <div class="mt-2">
        <input id="kondisi" name="kondisi" type="text" value="{{ old('kondisi') }}" class="block w-full rounded-md border-0 py-1.5 pl-3 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm">
    </div>
</div>
